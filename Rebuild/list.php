...
<html>
	...
	<body>
	    	...
	    	<div class="container">
	    		...
	    		<div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
	    			<ul class="navbar-nav">
						...
						<li class="nav-item">
	    					<a class="nav-link" href="<?php echo 'loan_type_pdf.php?type='.$type.''?>"><i class="fa fa-file-pdf-o"></i>&nbsp;Export to PDF</a>
			          	</li>
	          		</ul>
	       		</div>
	      	</div>
    	...
    	<!-- List Page Contents -->
    	<h1 class="text-center jumbotron-fluid py-3"><?php echo $type ?></h1>
		<?php
        ...
        <div class = "text-md-center  py-5">
			<p>
				<a href = "index.php" title = "Let's go back!">&#8617; Go Back to the Home Page</a>
			</p>
		</div>
