...
//*** Load MySQL Data ***//
	...
	$type = $_GET['type'];
		...
		$query = mysql_query("SELECT LOAN_YEAR, LOAN_SEM, LOAN_TYPE, STUD_NUM, STUD_NAME, STUD_YEAR, STUD_COURSE, STUD_ADDRESS, STUD_CONTACT, STUD_EMAIL, OUT_BAL FROM STUDENT WHERE LOAN_TYPE = '$type'");
		$resultData = array();
